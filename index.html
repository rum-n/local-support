				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								<a href="#" class="fh5co-sub-ddown">Обекти</a>
								 <!-- <ul class="fh5co-sub-menu">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="feature-left">
							...
							<div class="feature-copy">
								<h3>Избери място</h3>
								<p>Разгледай списъка ни със заведения. Твоето любимо място не е сред тях? Свържи се с тях и им предложи да се присъединят!</p>
					...
					<div class="col-md-4">
						<div class="feature-left">
							...
							<div class="feature-copy">
								<h3>Купи ваучер</h3>
								<p>Избери стойността на ваучера, който искаш да закупиш. Парите за ваучера отиват директно към заведението, което избереш. Така ще помогнеш на собствениците да покрият своите разходи.</p>
								<!-- <p><a href="#">Learn More</a></p> -->
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="feature-left">
							...
							<div class="feature-copy">
								<h3>Използвай ваучера</h3>
								<p>Ваучерите са без краен срок. Когато избраното от теб заведение отново отвори врати, ще можеш да отидеш и да го използваш там. </p>
								<!-- <p><a href="#">Learn More</a></p> -->
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center heading-section">
						<h3>Защо ваучери?</h3>
						<p>Поради обявеното извънредно положение, много заведения затвориха врати. Но разходите за тях, за наем, за персонал - продължават да се трупат. Така любимите ни ресторанти, кафенета и барове са поставени пред възможността да затворят врати завинаги.</p>
						<p>Ние можем да им помогнем като платим сега за бъдещата си консумацията.</p>
					</div>
				</div>
